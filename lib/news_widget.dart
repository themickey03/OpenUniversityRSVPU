          ...
          itemBuilder: (context, index) {
            ...
            return Padding(
              ...
              child: Card(
                  ...
                  child: InkWell(
                    onTap: () {
                      Navigator.of(context).push(MaterialPageRoute(builder: (context)=>SingleNewsWidget(singleNewsModel: new SingleNewsModel(title, imagelink, description, truePublishDate, views),)));
                    },
                    child: SizedBox(
                        child: Column(
