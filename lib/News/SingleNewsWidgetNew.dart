                ...
                children: [
                  ...
                  Expanded(
                    child: Align(
                      ...
                      child: Text("Дата публикации: ${singleNewsModelNew.publish_time}",
                        style: const TextStyle(
                      ...
                      if (singleNewsModelNew.content[index]['tag'] == 'p'){
                        return Padding(
                          ...
                          ? Padding(
                            ...
                            child: Text(singleNewsModelNew.content[index]["value"],
                                style: const TextStyle(fontSize: 16),
                                softWrap: true,
                               ...
                               child: Column(
                                 ...
                                 children: [
                                   ...
                                   ? Padding(
                                     ...
                                     child: Align(
                                       alignment: Alignment.center,
                                       child: Text(singleNewsModelNew.content[index]["value"]["name"],
                                   ...
                                   : Container(),
                                   singleNewsModelNew.content[index]["value"]["text"] != ""
                                   ? Text(singleNewsModelNew.content[index]["value"]["text"],
                                       style: const TextStyle(fontSize: 16),
                                       softWrap: true,
                                       textAlign: TextAlign.justify)
                                   : Container()
                        ...
                        if (singleNewsModelNew.content[index]["value"] != ""){
                          return Padding(
                            ...
                            child: SizedBox(
                              ...
                              child: CachedNetworkImage(
                                placeholder: (context, url) => const Image(image: AssetImage('images/Loading_icon.gif')),
                                imageUrl: singleNewsModelNew.content[index]["value"],
                                fit: BoxFit.cover,
                                width: double.maxFinite,
                                height: double.maxFinite,
                                alignment: Alignment.topCenter,
